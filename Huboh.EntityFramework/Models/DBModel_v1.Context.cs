...
namespace Huboh.EntityFramework.Models
{
    ...
    public partial class HubohDB_v1Entities : DbContext
    {
        public HubohDB_v1Entities()
            : base("name=HubohDB_v1Entities")
        {
        }
        ...
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ReseedAll");
        }
